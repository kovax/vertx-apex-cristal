...
public interface Lookup {
    ...
    /**
     * Connect to the directory using the credentials supplied in the
     * Authenticator.
     * 
     * @param user
     *            The connected Authenticator. The Lookup implementation may use
     *            the AuthObject in this to communicate with the database.
     */
    public void open();
    ...
    /**
     * Fetch the correct  for a particular Item,
     * derived from its lookup entry. This is used by the CORBA Server to make
     * sure the correct Item subclass is used.
     * 
     * @param sysKey
     *            The system key of the Item
     * @return an ItemPath or AgentPath
     * @throws InvalidItemPathException
     *             When the system key is invalid/out-of-range
     * @throws ObjectNotFoundException
     *             When the Item does not exist in the directory.
     */
     ...
     * @param domainPath
     *            The path to resolve
     * @return The ItemPath it points to (should be an AgentPath if the path
     *         references an Agent)
     * @throws InvalidItemPathException
     * @throws ObjectNotFoundException
     */
     ...
     * @return An Iterator of matching Paths. Should be an empty Iterator if
     *         there are no matches.
     */
    public Iterator<Path> search(Path start, String name);

    /**
     * Search for Items in the specified path with the given property name and
     * value
     * 
     * @param start
     *            Search root
     ...
     *            Search root
     * @param props
     *            Properties unmarshalled from an ItemDescription's property
     *            description outcome.
     * @return An Iterator of matching Paths
     */
    ...
    /**
     * Returns all of the Agents in this centre who hold this role (including
     * sub-roles)
     * 
     * @param agentPath
     * @param role
